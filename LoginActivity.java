...
public class LoginActivity extends FragmentActivity implements
    ...
    private String userType = "PUBLIC";

    private ImageButton mLogin_btn;
    private Button signup;

    private Spinner spinner;
    private static final String[]paths = {"PUBLIC", "OFFICIALS"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginEmail = (EditText) findViewById(R.id.contact_details);
        mLoginPassword = (EditText) findViewById(R.id.message_details);
...
//                        uid = auth.getCurrentUser().getUID();
                        ...
                        mUserDatabase.child(current_user_id).child("Device_Token").setValue(deviceToken).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                mainIntent.putExtra("user_info",userType);
                                startActivity(mainIntent);
                                finish();
