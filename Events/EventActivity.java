...
import com.mxn.soul.flowingdrawer.RegisterActivity;
...
public class EventActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (mAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(EventActivity.this, RegisterActivity.class);
            ...
            protected void populateViewHolder(BlogzoneViewHolder viewHolder, Blogzone model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleActivity = new Intent(EventActivity.this, SinglePostActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAuth.signOut();
            Intent logouIntent = new Intent(EventActivity.this, RegisterActivity.class);
