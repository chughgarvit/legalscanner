...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostProgress = new ProgressDialog(this);
...
//                Toast.makeText(PostActivity.this, "POSTING...", Toast.LENGTH_LONG).show();
                mPostProgress.setTitle("Uploading the event...");
                mPostProgress.setMessage("Please wait while we upload the post.");
                mPostProgress.setCanceledOnTouchOutside(false);
                mPostProgress.show();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onCancelled(DatabaseError databaseError) {
                                    ...
                                    Toast.makeText(PostActivity.this, "Error in uploading : "+databaseError, Toast.LENGTH_SHORT).show();
